...
const NewPatternForm = (props) => {
    ...
    const handleSubmit = (e) => {
        ...
        PatternService.createNewPattern(patternData.formData)
            .then(() => {
                setPatternData({
                    formData: {
                        patternTitle: "",
    ...
    return (
        <div className="formBox">
            <h1 class="d-flex justify-content-center mx-auto p-2 text-info">Create a new Pattern</h1>
            <form onSubmit={(e) => handleSubmit(e)}>
                ...
                <input type="submit" value={`Add Pattern to Library`} class="gradient-advanced d-flex justify-content-center mx-auto p-2 my-3" />
            </form>
        </div>
    )
}
